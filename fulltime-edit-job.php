...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Edit Job Posting - Full Time</title>
...
<body class="stretched">
						                ...
						                <div class="panel-footer">
						                	...
						                	<div class="form-group btn-job-group-post">
					                            <div class="col-md-8 col-xs-9 col-md-offset-6 col-sm-offset-6 col-xs-offset-3">
					                                <a href="jobs-list.php?employment_type_id=1" class="btn btn-primary">
					                                    Cancel
					                                </a>
	...
	<script type="text/javascript">
		var jobGroupID = '<?php echo isset($_GET['job_group_id']) ? $_GET['job_group_id'] : ""; ?>';
		var postTypeID = '<?php echo isset($_GET['post_type_id']) ? $_GET['post_type_id'] : ""; ?>';
	</script>
